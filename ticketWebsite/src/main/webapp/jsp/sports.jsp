...
<head>
	<meta charset="UTF-8">
    <title>Sports Event Reservation</title>
    <link rel="stylesheet" href="../styles/musical.css">
</head>
<body>
	<h2>스포츠 이벤트 티켓 예약</h2>
	<h3 style="margin-left: 20%;">다가오는 스포츠 이벤트들</h3>
	<div class="concerts-container">
	    <%
	        ...
	        try {
	            ...
	            String query = "SELECT Concert_ID, Concert_Name, Con_date, Tic_start, Tic_end, Place, Price FROM CONCERT WHERE genre='sports'";
